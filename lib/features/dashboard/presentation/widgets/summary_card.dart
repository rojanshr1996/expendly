        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              AppSpacing.gapBase,
              Text(
                '$activeSymbol${summary.totalBalance.toStringAsFixed(2)}',
                ...
                children: [
                  Expanded(
                    child: _MetricTile(
                      label: l10n.income,
                      amount:
                          '$activeSymbol${summary.totalIncome.toStringAsFixed(2)}',
                  ...
                  Expanded(
                    child: _MetricTile(
                      label: l10n.expenses,
                      amount:
                          '$activeSymbol${summary.totalExpense.toStringAsFixed(2)}',
