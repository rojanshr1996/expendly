    ...
    if (settlements.isEmpty) {
      return Align(
        ...
        child: Padding(
          padding: padding ??
              EdgeInsets.only(
                left: isTablet ? 0 : 20.w,
                right: isTablet ? 0 : 20.w,
                top: isTablet ? 12.0 : 68.h,
                bottom: isTablet ? 16.0 : 24.h,
              ),
          child: GlassContainer(
            padding: EdgeInsets.symmetric(
              horizontal: isTablet ? 20.0 : 24.w,
              vertical: isTablet ? 24.0 : 28.h,
            ),
            child: Column(
              mainAxisSize: MainAxisSize.min,
              children: [
                Container(
                  width: isTablet ? 52.0 : 56.w,
                  height: isTablet ? 52.0 : 56.w,
      ...
      builder: (context, selectedId, child) {
        ...
        return ListView(
          ...
          padding: padding ??
              (isTablet
                  ? EdgeInsets.zero
                  : EdgeInsets.fromLTRB(0, 60.h, 0, 96.h)),
          children: [
            // User selector
            SizedBox(
              height: isTablet ? 68.0 : 76.h,
              child: ListView.builder(
                scrollDirection: Axis.horizontal,
                itemCount: participants.length,
                padding: EdgeInsets.symmetric(
                  horizontal: isTablet ? 0 : 20.w,
                ),
                          ...
                          Stack(
                            ...
                            children: [
                              Container(
                                ...
                                padding: EdgeInsets.all(isTablet ? 2.0 : 2.w),
            ...
            if (filteredSettlements.isEmpty)
              Padding(
                ...
                child: GlassContainer(
                  padding: EdgeInsets.symmetric(
                    horizontal: isTablet ? 16.0 : 24.w,
                    vertical: isTablet ? 20.0 : 28.h,
                  ),
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                  ...
                  children: [
                    ...
                    ...participants.map((p) {
                      ...
                      return InkWell(
                        onTap: () => _selectedUserId.value = p.id,
                        borderRadius:
                            BorderRadius.circular(isTablet ? 8.0 : 10.r),
                        child: Container(
                          padding: EdgeInsets.symmetric(
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                style: context
                                    ...
                                    .copyWith(
                                  color: badgeColor,
                                  fontSize: isTablet ? 12.0 : 12.5.sp,
                                  fontWeight: FontWeight.bold,
                                ),
                              ),
                            ],
