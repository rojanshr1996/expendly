...
class $AssetsImagesGen {
  ...
  AssetGenImage get expendlyIconDev => const AssetGenImage('assets/images/expendly_icon_dev.png');

  /// File path: assets/images/expendly_icon_light.png
  AssetGenImage get expendlyIconLight => const AssetGenImage('assets/images/expendly_icon_light.png');

  /// File path: assets/images/expendly_icon_qa.png
  AssetGenImage get expendlyIconQa => const AssetGenImage('assets/images/expendly_icon_qa.png');
  ...
  List<AssetGenImage> get values =>
      [expendlyIcon, expendlyIconDev, expendlyIconLight, expendlyIconQa, expendlyLogo, expendlyLogoLight];
}
